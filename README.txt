...
Defined a function (dataget) in models.py that:
	Used repuests module to get data from required api. 
	Converted datestring to dateobject.
	Created and returned a list of dictionaries having only the specified data.(l)

Used dataget function in index function in views.py to get list and then,
using for loop  inputted the data into the database and displayed the data from database using index.html.
